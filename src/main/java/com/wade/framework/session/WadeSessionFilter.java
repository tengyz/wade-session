...
import com.wade.framework.storage.redis.RedisStorage;

/**
 * session拦截器
 * @Description session拦截器 
 * @ClassName   WadeSessionFilter 
 * @Date        2017年11月23日 下午2:03:30 
 * @Author      yz.teng
 */
public class WadeSessionFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        chain.doFilter(new WadeSessionReqeust((HttpServletRequest)request, (HttpServletResponse)response), response);
    }
